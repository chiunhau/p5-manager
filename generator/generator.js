...
var Style = {
	scss: loadFile("Style/Style.scss"),
	css: loadFile("Style/Style.css"),
};
...
function createStyle(dirName) {
	mkdir(dirName + "/Style", function () {
		write(dirName + "/Style/Style.scss", Style.scss);
...
function createOther(dirName) {
	mkdir(dirName + "/Meta", function (...args) {
		mkdir(dirName + "/Meta/Sound", function () {});
		mkdir(dirName + "/Meta/Image", function () {});
		mkdir(dirName + "/Meta/other", function () {});
	});
}
